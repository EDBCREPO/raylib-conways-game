...
var ASM_CONSTS = {
  114548: ($0, $1) => { let data = Date.now() + ""; stringToUTF8( data, $0, $1 ); return data.length; },  
 114630: () => { if (document.fullscreenElement) return 1; },  
 114676: () => { return document.getElementById('canvas').width; },  
 114728: () => { return parseInt(document.getElementById('canvas').style.width); },  
 114796: () => { document.exitFullscreen(); },  
 114823: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 114896: () => { if (document.fullscreenElement) return 1; },  
 114942: () => { return document.getElementById('canvas').width; },  
 114994: () => { return screen.width; },  
 115019: () => { document.exitFullscreen(); },  
 115046: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 115179: () => { return window.innerWidth; },  
 115205: () => { return window.innerHeight; },  
 115232: () => { if (document.fullscreenElement) return 1; },  
 115278: () => { return document.getElementById('canvas').width; },  
 115330: () => { return parseInt(document.getElementById('canvas').style.width); },  
 115398: () => { if (document.fullscreenElement) return 1; },  
 115444: () => { return document.getElementById('canvas').width; },  
 115496: () => { return screen.width; },  
 115521: () => { return window.innerWidth; },  
 115547: () => { return window.innerHeight; },  
 115574: () => { if (document.fullscreenElement) return 1; },  
 115620: () => { return document.getElementById('canvas').width; },  
 115672: () => { return screen.width; },  
 115697: () => { document.exitFullscreen(); },  
 115724: () => { if (document.fullscreenElement) return 1; },  
 115770: () => { return document.getElementById('canvas').width; },  
 115822: () => { return parseInt(document.getElementById('canvas').style.width); },  
 115890: () => { document.exitFullscreen(); },  
 115917: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 115975: () => { return screen.width; },  
 116000: () => { return screen.height; },  
 116026: () => { return window.screenX; },  
 116053: () => { return window.screenY; },  
 116080: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 116133: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 116204: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 116261: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 116517: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 116588: () => { if (document.fullscreenElement) return 1; },  
 116634: () => { return window.innerWidth; },  
 116660: () => { return window.innerHeight; },  
 116687: () => { if (document.pointerLockElement) return 1; }
};
